...
const users = [
  ...
  { name: "Vrushti", email: "vrushti@infotact.in", role: "SOC Analyst", status: "Active"},
  { name: "Ushvi", email: "ushvi@infotact.in", role: "Senior Analyst", status: "Active"},
  { name: "Samruddhi", email: "samruddhi@infotact.in", role: "Engineer", status: "Active"},
  { name: "Riya", email: "riya@infotact.in", role: "Senior Analyst", status: "Active"}
];

function roleColor(role) {
  if (role.includes("Senior Analyst")) return "var(--accent-purple)";
  if (role.includes("SOC Analyst")) return "var(--color-high)";
  if (role.includes("Engineer")) return "var(--color-low)";
