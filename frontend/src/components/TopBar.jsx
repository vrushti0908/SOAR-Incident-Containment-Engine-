...
const STATIC_NOTIFS = [
  { id: 1, text: "New critical alert triggered", time: "2m ago", unread: true },
  { id: 2, text: "Playbook run completed", time: "1h ago", unread: true },
  { id: 3, text: "Case #482 assigned to you", time: "3h ago", unread: false },
];
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", marginTop: 20 }}>
              ...
              <button
                onClick={() => { setShowPasswordModal(false); alert("Password changed!"); }}
                style={{
                  background: "var(--accent-purple)",
                  border: "none",
                  color: "white",
