...
>>>>>>> vrushti
  ...
  // Bahar click karne se dono dropdowns band ho jayenge
  useEffect(() => {
  ...
  const profileItems = [
    {
      label: "My profile",
      icon: User,
      action: () => { setShowProfile(false); navigate("/users"); }
    },
    {
      label: "Change password",
      icon: Lock,
      action: () => { setShowProfile(false); setShowPasswordModal(true); }
    },
    {
      label: "Settings",
      icon: Settings,
      action: () => { setShowProfile(false); navigate("/settings"); }
    },
    {
      label: "Log out",
      icon: LogOut,
              ...
              >
                ...
                {notifs.map((n) => (
                  <div
                    ...
                    onMouseLeave={(e) => e.currentTarget.style.background = n.unread ? "var(--bg-card-hover)" : "transparent"}
                    style={{
                      padding: "10px 16px",
                      borderBottom: "1px solid var(--border)",
            ...
            {showProfile && (
              ...
              >
                <div style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)" }}>
                  <div style={{ fontSize: 13, fontWeight: 600 }}>Bob</div>
                  <div style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 2 }}>bob@infotact.in</div>
                  ...
                  return (
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => {
                        ...
                        e.currentTarget.style.color = item.danger ? "var(--color-critical)" : "var(--text-primary)";
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = "transparent";
                        e.currentTarget.style.color = item.danger ? "var(--color-critical)" : "var(--text-secondary)";
                      }}
                      style={{
                        display: "flex",
                        alignItems: "center",
                        ...
                        background: "transparent",
                        border: "none",
                        borderBottom: idx < profileItems.length - 1 ? "1px solid var(--border)" : "none",
                        textAlign: "left",
                        fontSize: 13,
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 999 }} onClick={() => setShowPasswordModal(false)}>
          <div onClick={(e) => e.stopPropagation()} style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 12, padding: 24, width: 340 }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", marginTop: 20 }}>
              ...
              <button
                onClick={() => { setShowPasswordModal(false); alert("Password changed successfully!"); }}
                style={{
                  background: "var(--accent-purple)",
                  border: "none",
                  color: "white",
